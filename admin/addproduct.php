                    ...
                    <div class="col-12 col-lg-6">
                        <form method="post" action="">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" id="productname" name="productname" required value="<?php if(isset($_POST['productname'])) { echo $_POST['productname']; } ?>">
                                <?php
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select name="category" id="category" class="form-select">
                                    ...
                                    <option value="Drinks" <?php if(isset($_POST['category']) && $_POST['category'] == 'Drinks') { echo 'selected'; } ?>>Drinks</option>
                                    <option value="Hamburger" <?php if(isset($_POST['category']) && $_POST['category'] == 'Hamburger') { echo 'selected'; } ?>>Hamburger</option>
                                </select>
                                <?php
                            ...
                            <div class="mb-2">
                                ...
                                <input type="number" step="any" class="form-control" id="price" name="price" required value="<?php if(isset($_POST['price'])) { echo $_POST['price']; } ?>">
                                <?php
